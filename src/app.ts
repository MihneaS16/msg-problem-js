import { checkingAccountA, checkingAccountB, savingsAccountA, savingsAccountB, checkingAccountC } from './seed/accounts.seed';
...
// console.log('[Transaction Manager] 7.', TransactionManagerServiceInstance.checkFunds(checkingAccountC.id));
